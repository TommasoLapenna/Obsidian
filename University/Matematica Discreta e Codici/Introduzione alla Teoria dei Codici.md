...
- Se $\underline{\omega}=101\Rightarrow$ decodifica univocamente a $101\in C$
 	...
 	- Se $\underline{\omega}=001,100,111\notin C\Rightarrow$ sicuramente c'è stato un errore di trasmissione (1. si) 	- Se mdd: $\underline{\omega}=001\rightarrow000\in C,011\in C,101\in C\Rightarrow$ non si sa decodificare in modo univoco
